...
class Ui_HelpWin(object):
    def setupUi(self, HelpWin):
        ...
        HelpWin.resize(270, 370)
        HelpWin.setMinimumSize(QtCore.QSize(270, 370))
        HelpWin.setMaximumSize(QtCore.QSize(270, 370))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("rules.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        HelpWin.setWindowIcon(icon)
        HelpWin.setIconSize(QtCore.QSize(40, 40))
        self.centralwidget = QtWidgets.QWidget(HelpWin)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 10, 251, 421))
