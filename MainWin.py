...
class Ui_MainWin(object):
    def setupUi(self, MainWin):
        ...
        self.tableView.setGeometry(QtCore.QRect(10, 30, 280, 280))
        self.tableView.setMinimumSize(QtCore.QSize(260, 280))
        ...
        self.levelspinBox.setGeometry(QtCore.QRect(240, 0, 42, 22))
