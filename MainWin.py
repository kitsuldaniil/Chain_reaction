...
class Ui_MainWin(object):
    def setupUi(self, MainWin):
        ...
        MainWin.resize(300, 375)
        MainWin.setMinimumSize(QtCore.QSize(300, 375))
        MainWin.setMaximumSize(QtCore.QSize(300, 375))
        icon = QtGui.QIcon()
        ...
        self.help = QtWidgets.QAction(MainWin)
        ...
        self.menuOptions.addAction(self.settings)
    ...
    def retranslateUi(self, MainWin):
        ...
        self.menuOptions.setTitle(_translate("MainWin", "Настройки"))
        ...
        self.help.setText(_translate("MainWin", "Помощь"))
        self.settings.setText(_translate("MainWin", "Параметры"))
